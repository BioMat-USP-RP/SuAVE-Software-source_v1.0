...
program densidade
  ...
  logical :: ex, bin, outer, water, p_grid, rmsd, l_coarse, map
  logical :: begin, end, skip, eval_skip, slices
  ...
  real :: dist_x, dist_y, dist_z, del, aux2, hour, minu, sec, s_grid, noir, al
  real :: dx, dy, dist, area, start, finish, n_water, r_fit, gridx, gz
  real :: z_max, z_min, x_max, x_min, y_max, y_min, gridy, maxv, minv
  ...
  write(*, *) ""
  write(*, *) "-water           used to calculate number of water" 
  write(*, *) "molecules inside the structure"
  write(*, *) ""
...
6 format(a10)
  ...
  if (slices) then
     ...
     write(*, *)
     write(*, 6, advance='no') ' slices = '
     read(*, *, iostat=ierr) div
  ...
  if (map)then
     ...
     if (ex) then
        ...
        write(*, *)
        write(*, *) 'Previous densmap.xpm file is now backed up to densmap_p.xpm !'
     ...
     write(4, *) '/* XPM */'
     write(4, *)'/* This matrix is generated by desloc.f90 */'
...
12   format(a6, i5.1, a5, a5, a1, i4.1, a4, 3f8.3)
  ...
  if (ex) then
     ...
     write(*, *)
     write(*, *) 'Previous density.xvg file is now backed up to density_p.xvg !'
...
5    format(a1)
  ...
  if (water)then
     ...
     write(*, *)
     write(*, *) "Water molecules inside the structure = ", n_water/tot_frame/3
     write(*, 2) " Percentage of molecules inside =  ", n_water*100/tot_frame/tot_dens, " %"
     write(*, 2) " Percentage of molecules outside = ", (1-n_water/tot_frame/tot_dens)*100, " %"
2    format(a35, f4.1, a2)
